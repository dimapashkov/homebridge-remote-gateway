...
class RemoteGatewayHomebridgePlatform {
    constructor(log, config, api) {
        ...
        // MQTT
        this.mqtt = aedes_1.default();
        this.mqttServer = net_1.default.createServer(this.mqtt.handle);
        this.mqttConnect();
        // WS
    ...
    wsConnect() {
        if (this.wsConnectionURL) {
            this.ws = new ws_1.default(this.wsConnectionURL);
            this.ws.on('open', () => {
